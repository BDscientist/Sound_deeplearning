...
for i in range(9):
    ...
    for r in y:
        if np.sum(r) > 1.5:
            print('error occured')
            break
    np.savez('/home/libedev/mute/mute-hero/download/urbansound/UrbanSound8K/audio/Final_DATASET_%d.npz'%i,X=X,y=y,groups=groups)