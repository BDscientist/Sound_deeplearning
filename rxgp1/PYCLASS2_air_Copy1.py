...
class my_datset2(Dataset):
    ...
    def __init__(self,train = True):
        ...
        total_test  = np.load('/home/libedev/mute/mute-hero/air_save/total2_test_air_dataset.npz')
        ...
        if self.train :
            ...
            x=np.array([0,0,0,0,0,0,0])
            self.test_data = np.zeros((194,200))
            ...
            self.test_data =self.test_data.reshape(194,1,10,20)
            dtype = torch.FloatTensor
